...
sudo apt -y install gcc-multilib g++-multilib systemtap-sdt-devel libx11-dev libxext-dev libxrender-dev libxtst-dev libxt-dev libasound2-dev libelf-dev libfontconfig1-dev
